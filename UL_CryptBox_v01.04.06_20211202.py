...
#	21. dukpt - adding
#   22. password gen has been updated --> [letters + numbers + special_characters]
...
root = tk.Tk()
root.title('CryptoBox v01.04.06 20211202')
...
class CryptoBox(tk.Tk):
    ...
    def rng_pwd(self):
        ...
        self.rng_pwd_textbox.delete(1.0, END)
        self.rng_pwd_textbox.insert(1.0, "".join(password))
        print("".join(password))
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.rng_32B_textbox = tk.Text(self.rng_bar_bar, font = "Courier 9", height=2, width=64)
        ...
        self.rng_butt_88B = tk.Button(self.rng_bar_bar, text="Generate a password", command=self.rng_pwd)
        self.rng_butt_88B.grid(row=10, column=1, padx=5, pady=5, sticky=W)
        self.rng_pwd_textbox = tk.Text(self.rng_bar_bar, font = "Courier 9", height=2, width=64)
        self.rng_pwd_textbox.grid(row=11, column=1, padx=5, pady=5, sticky=N+W)
