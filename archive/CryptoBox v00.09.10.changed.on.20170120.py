...
'''
root = tk.Tk()
root.title('CryptoBox v00.09.09.x20161219')
root.geometry("560x450+0+0")
...
timeText = tk.Label(root, text="", font=("Fixedsys", 20))
...
class CryptoBox(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.rsa_data_in = tk.Entry(frame_3_2_RSA, font = "Courier 10", width=48)
        ...
        self.rsa_data_out = tk.Text(frame_3_2_RSA, font = "Courier 10", height=8, width=48)
        ...
        #   7   120 PINs
        self.pin_120_bar = tk.LabelFrame(frame_7_120, text="Elapsed time of 120 online PINs !", font=("Fixedsys", 12, "bold"), padx=5, pady=5)
        self.pin_120_bar.grid(row=1, column=1, columnspan=4)
        self.text = tk.Label(self.pin_120_bar, text="", font=('Helvetica', 40), bg="white")
        self.text.pack()
