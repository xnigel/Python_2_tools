...
class CryptoBox(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.RSA_pri_key_lb.grid(row=2, column=1, padx=5, pady=5, sticky=W+N)
        ...
        self.RSA_key_pair_gen_bot.grid(row=4, column=2, padx=5, pady=5, sticky=N+E)

        self.RSA_k_len_lb = tk.Label(self.Key_Gen, text="key len")
        self.RSA_k_len_lb.grid(row=4, column=1, padx=5, pady=5, sticky=N+W)
        self.RSA_k_len_En = tk.Entry(self.Key_Gen, width=5)
        self.RSA_k_len_En.grid(row=4, column=2, padx=5, pady=5, sticky=N+W)
        ...
        self.rsa_data_work = tk.LabelFrame(frame_3_2_RSA, text="RSA Calculator",
