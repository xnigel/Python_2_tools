...
class CryptoBox(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        #   7   120 PINs
        self.pin_120_bar = tk.LabelFrame(frame_7_120, text="Elapsed time of 120 online PINs", padx=20, pady=10)
        self.pin_120_bar.grid(row=1, column=1, rowspan=4)

        #   8   About CryptoBox
        self.abt_bar = tk.LabelFrame(frame_8_ABT, text=" --- CryptoBox --- ")
