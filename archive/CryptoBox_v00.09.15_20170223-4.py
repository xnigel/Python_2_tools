...
class CryptoBox(tk.Tk):
    ...
    def RSA_key_pair_gen_func(self):
        ...
        print "public:", public
        print "\n#  0  -----------------------------------------------------------------------------"
        print "bin_pvtKey:", binascii.b2a_hex(bin_pvtKey)
        print "\nbin_pubKey:", binascii.b2a_hex(bin_pubKey)
        print "\n#  1  -----------------------------------------------------------------------------"
        #print "bin_pvtKey\nbinascii.b2a_hex(bin_pvtKey):", binascii.b2a_hex(bin_pvtKey)
        #print "bin_pubKey\nbinascii.b2a_hex(bin_pubKey):", binascii.b2a_hex(bin_pubKey)
        print "\n#  2  -----------------------------------------------------------------------------"
        print "e_data_rsa:", hex(e_data_rsa)
        print "p_data_rsa:", hex(p_data_rsa)
        print "\n#  3  -----------------------------------------------------------------------------"
        print 'pri:', '\npri.e:', hex(private.e), '\npri.d:', hex(private.d), '\npri.n:', hex(private.n)
    ...
    def rsa_key_import_func(self):
        ...
        #RSAObj = RSA.construct((rsa_input_pri, rsa_input_exp))
        '''
        print "test_n", hex(test_n)
        print "test_e", hex(test_e)
        print "test_d", hex(test_d)

        print "test_n2", hex(temp_n)
        print "test_e2", hex(temp_e)
        print "test_d2", hex(temp_d)
        ...
        print "rsa_input_exp", rsa_input_exp
        print "rsa_input_pri", rsa_input_pri
        print "rsa_input_pub", rsa_input_pub
        print "pri_temp", pri_temp, "\npub_temp", pub_temp
        print "e_data_rsa", hex(e_data_rsa)
        print "p_data_rsa", hex(p_data_rsa)
        '''
        print "rsa_input_exp", binascii.a2b_hex(rsa_input_exp)
        print "rsa_input_pri", binascii.a2b_hex(rsa_input_pri)
        print "rsa_input_pub", binascii.a2b_hex(rsa_input_pub)
        '''
        #print "\nRSAObj", RSAObj
