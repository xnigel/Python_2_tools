...
class CryptoBox(tk.Tk):
    ...
    def rsa_key_import_func(self):
        ...
        with open("RSA_n.hex", "r") as RSA_n_temp:
            #RSA_n_temp.write(hex(private.dn))
        '''
        print "\ncomparing!!===================\n"
        print "test_value_e:\n", 0x3L
        print "test_value_d:\n", test_value_d
        ...
        pri_temp = RSA.construct((test_n, test_e, test_d))
        pub_temp = RSA.construct((test_n, test_e))


        #pri_temp = RSA.construct((test_value_n, test_value_e, test_value_d))
        #pub_temp = RSA.construct((test_value_n, test_value_e))

        data_rsa = 0x241234ffffffffffL
        e_data_rsa = pub_temp.encrypt(data_rsa, 0)[0]
        p_data_rsa = pri_temp.decrypt(e_data_rsa)
