...
root.geometry("700x560+0+0")    #("600x450+0+0") is in Linux; ("600x450+0+0") is in Windows
...
class CryptoBox(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        #   5   XOR
        self.XOR_frame = tk.LabelFrame(frame_5_XOR, text="XOR", font=("Helvetica", 12, "bold"), padx=5, pady=5, bd=4)
