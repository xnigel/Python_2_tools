# ________/\\\\\\\\\________________________________________________________________________/\\\\\\\\\\\\\________________________________
# ______/\\\////////________________________________________________________________________\/\\\/////////\\\______________________________
# _____/\\\/____________________________/\\\__/\\\___/\\\\\\\\\______/\\\____________________\/\\\_______\/\\\______________________________
# _____/\\\______________/\\/\\\\\\\____\//\\\/\\\___/\\\/////\\\__/\\\\\\\\\\\_____/\\\\\____\/\\\\\\\\\\\\\\______/\\\\\_____/\\\____/\\\__
# _____\/\\\_____________\/\\\/////\\\____\//\\\\\___\/\\\\\\\\\\__\////\\\////____/\\\///\\\__\/\\\/////////\\\___/\\\///\\\__\///\\\/\\\/___
# ______\//\\\____________\/\\\___\///______\//\\\____\/\\\//////______\/\\\_______/\\\__\//\\\_\/\\\_______\/\\\__/\\\__\//\\\___\///\\\/_____
# ________\///\\\__________\/\\\__________/\\_/\\\_____\/\\\____________\/\\\_/\\__\//\\\__/\\\__\/\\\_______\/\\\_\//\\\__/\\\_____/\\\/\\\____
# ___________\////\\\\\\\\\_\/\\\_________\//\\\\/______\/\\\____________\//\\\\\____\///\\\\\/___\/\\\\\\\\\\\\\/___\///\\\\\/____/\\\/\///\\\__
# _______________\/////////__\///___________\////________\///______________\/////_______\/////_____\/////////////_______\/////_____\///____\///___
# _________________________________________________________________________________________________________________________________________________
# ____________/\\\\\_____/\\\____________________________________/\\\\\\____________________________________________________________________________
# ____________\/\\\\\\___\/\\\___________________________________\////\\\____________________________________________________________________________
# _____________\/\\\/\\\__\/\\\__/\\\___/\\\\\\\\____________________\/\\\____________________________________________________________________________
# ______________\/\\\//\\\_\/\\\_\///___/\\\////\\\_____/\\\\\\\\_____\/\\\____________________________________________________________________________
# _______________\/\\\\//\\\\/\\\__/\\\_\//\\\\\\\\\___/\\\/////\\\____\/\\\____________________________________________________________________________
# ________________\/\\\_\//\\\/\\\_\/\\\__\///////\\\__/\\\\\\\\\\\_____\/\\\____________________________________________________________________________
# _________________\/\\\__\//\\\\\\_\/\\\__/\\_____\\\_\//\\///////______\/\\\____________________________________________________________________________
# __________________\/\\\___\//\\\\\_\/\\\_\//\\\\\\\\___\//\\\\\\\\\\__/\\\\\\\\\_________________________________________________________________________
# ___________________\///_____\/////__\///___\////////_____\//////////__\/////////__________________________________________________________________________
...
#
#   DES operation works very well on v00.08.08.x
#   v00.07.07 has been added new buttons:
...
'''
root = tk.Tk()
root.title('CryptoBox v00.08.08.x')
root.geometry("666x480+0+0")
algo_tab = ttk.Notebook(root)
frame_1_TDES = ttk.Frame(algo_tab)
frame_2_AES = ttk.Frame(algo_tab)
frame_3_RSA = ttk.Frame(algo_tab)
...
algo_tab.add(frame_3_RSA, text='RSA')
...
class CryptoBox(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.key_ck_value_TDES = tk.Text(frame_1_TDES, height=1, width=3)
        ...
        self.EncOrDec_bar_RSA = tk.LabelFrame(frame_3_RSA, text="Operation", padx=10, pady=10)
        ...
        #   3.2 Key Gen
        self.Key_Gen = tk.LabelFrame(frame_3_RSA, text="RSA Key Pair Generation", padx=10, pady=10)
        ...
        self.pri_key_textbox = tk.Text(self.Key_Gen, height=6, width=64)
        ...
        self.pub_key_textbox = tk.Text(self.Key_Gen, height=6, width=64)
        ...
        #   3.3 key file
        self.key_pub_butt_RSA = tk.Button(frame_3_RSA, text="Encrypt data", width=11, command=self.execution_RSA_enc)
        self.key_pub_butt_RSA.grid(row=5, column=1, padx=3, pady=5, sticky=W)
        self.key_pri_butt_RSA = tk.Button(frame_3_RSA, text="Decrypt data", width=11, command=self.execution_RSA_dec)
        self.key_pri_butt_RSA.grid(row=6, column=1, padx=3, pady=5, sticky=W)
        '''
        self.key_label_RSA = tk.Label(frame_3_RSA, text="Key value: ")
        self.key_label_RSA.grid(row = 5, column = 0)
        self.key_textbox_AES= tk.Entry(frame_2_AES, width = 41)
        self.key_textbox_AES.grid(row = 5, column = 1, columnspan = 2, padx=5, pady=5, sticky=W)
        '''
        #   3.3 input file - plaintext/enciphered binary data
        self.rsa_p_data_ent = tk.Entry(frame_3_RSA, width=64)
        self.rsa_p_data_ent.grid(row=5, column=2, padx=3, pady=3, sticky=W)
        #   3.4 output file - enciphered/plaintext binary data
        ...
        self.rng_8B_textbox = tk.Text(self.rng_bar_bar, height=1, width=18)
        self.rng_8B_textbox.grid(row=5, column=1, padx=5, pady=5)
        self.rng_butt_8B = tk.Button(self.rng_bar_bar, text="Generate 32byte", command=self.rng_gen_32B)
        self.rng_butt_8B.grid(row=6, column=1, padx=5, pady=5, sticky=W)
        self.rng_32B_textbox = tk.Text(self.rng_bar_bar, height=4, width=18)
    ...
    def RSA_key_pair_gen_func(self):
        ...
        with open("pvt.rsa", "w") as pub_key:
            pvt_key.write(private.exportKey())

    def execution_RSA_enc(self):
        print "RSA Algo is under developing..."
        rsa_p_data = StringVar()
        rsa_p_data = self.rsa_p_data_ent.get()
        print 'rsa_p_data:', rsa_p_data

        with open('pub.rsa', 'r') as pub_key_file:
            pub_key = RSA.importKey(pub_key_file.read())
            enciphered_data = pub_key.encrypt(rsa_p_data.decode('hex'), None)
            #enciphered_data_encoded = enciphered_data.encode('hex')
            print 'enciphered_data:', enciphered_data
            print  str(enciphered_data)
            pub_key_file.write(str(enciphered_data))
            pub_key_file.close
