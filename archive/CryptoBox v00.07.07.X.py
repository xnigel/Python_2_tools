...
#
#   DES operation works very well on v00.07.07.x
...
'''
root = tk.Tk()
root.title('CryptoBox v00.07.07.x')
root.geometry("540x420+0+0")
...
class CryptoBox(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.EncOrDec_bar_RSA.grid(row=1, column=1, rowspan=4, sticky=W)
        ...
        #   3.2 key file
        self.key_pub_butt_RSA = tk.Button(frame_3_RSA, text="RSA public  key", width=11, command=self.pub_key_filename)
        self.key_pub_butt_RSA.grid(row=5, column=1, padx=3, pady=5, sticky=W)
        self.key_pri_butt_RSA = tk.Button(frame_3_RSA, text="RSA private key", width=11, command=self.pri_key_filename)
