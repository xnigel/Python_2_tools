...
root = tk.Tk()
root.title('CryptoBox v01.02.03 20170606')
root.geometry("540x440+200+200")    #("560x480+0+0") for Linux; ("530+470+20+20") for Windows
...
default_key = StringVar(frame_1_TDES, value = "0123456789ABCDEF123456789ABCDEF0")
# default_key = StringVar(frame_2_AES, value = "0123456789ABCDEF123456789ABCDEF0")
default_iv_des = StringVar(frame_1_TDES, value = "0000000000000000")
default_iv_aes = StringVar(frame_2_AES, value = "00000000000000000000000000000000")
...
class CryptoBox(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.key_textbox_TDES = tk.Entry(frame_1_TDES, textvariable = default_key, font = "Courier 9", width=64)
        ...
        self.iv_textbox_TDES = tk.Entry(frame_1_TDES, textvariable = default_iv_des, font = "Courier 9", width=64)
        ...
        self.key_textbox_AES = tk.Entry(frame_2_AES, textvariable = default_key, font = "Courier 9", width=64)
        ...
        self.iv_textbox_AES = tk.Entry(frame_2_AES, textvariable = default_iv_aes, font = "Courier 9", width=64)
        ...
        self.rsa_import_meth_1 = tk.Radiobutton(self.rsa_key_import, text="Import keys from .imp files",
                                                indicator=0, value=1, width=25, variable=KEY_IMPORT_METHOD)
        self.rsa_import_meth_1.grid(row=2, column=2, padx=5, pady=1, sticky = W)

        self.rsa_import_meth_2 = tk.Radiobutton(self.rsa_key_import, text="Import keys from the 3 boxes ",
                                                indicator=0, value=2, width=25, variable=KEY_IMPORT_METHOD)
